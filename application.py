...
def delete_product(product_id):
    ...
    return jsonify({"message": "Invalid bot found"}), 400

# retornar as informações do produto via ID, caso não ache retorna erro 404 not found
...
# atualizar os dados dos produtos, caso não ache o produto erro 404 not found
...
# checkout, apaga todos os itens do carrinho
